...
files <- list.files(fa3_dir, pattern = "^[0-9]{4}_fa3\\.xls[x]?$", full.names = TRUE)
...
write.csv(fa3, file.path(intermediate_data_dir, "FHWA_Highway_Statistics/FA3_interstate_1994_2024.csv"), row.names = FALSE)
